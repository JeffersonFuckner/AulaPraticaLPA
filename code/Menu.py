        ...
        while True:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    pygame.quit()
                    sys.exit()
                if event.type == pygame.KEYDOWN:  # test if some key was pressed
                    if event.key == pygame.K_DOWN:  # if some key down was pressed
                        if menu_option < len(MENU_OPTION) - 1:
                            menu_option += 1
                        else:
                            menu_option = 0
                    if event.key == pygame.K_UP:  # if some key down was pressed
                        if menu_option > 0:
                            menu_option -= 1
                        else:
